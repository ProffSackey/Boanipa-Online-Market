          ...
          <div>
            ...
            <form className="mt-4 flex items-center max-w-xs">
              <input
                ...
                className="w-full px-3 py-2 rounded-l-md border border-gray-200 text-sm focus:outline-none bg-gray-100"
              />
              <button className="bg-orange-500 hover:bg-orange-600 text-white px-2 py-2 rounded-r-md text-sm w-20">Subscribe</button>
            </form>
          </div>
        </div>
